---
title: Von der Datenquelle zur PowerPointPräsi in einer Anwendung
...
Je nach Datensatz ist sogar eine weitere Partitionierung möglich,
so dass noch differenzierter gearbeitet werden kann.
Es lassen sich darüber hinaus die verschiedensten Tabellen mit dem [officer](https://davidgohel.github.io/officer/articles/offcran/tables.html) Paket 
erstellen. 

Das wichtigste bei diesem Workflow ist jedoch dass die beschriebenen Fallstricke,
vermieden werden, da kein Im und Export in MS-Office durchgeführt werden muss, sondern
alles innerhalb einer Anwendung bearbeitet werden kann.


### Addendum zur Reporduktion:
```{r,echo=FALSE, eval=TRUE}
sessionInfo()
```
