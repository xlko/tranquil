...
Wenn die Anzahl sich auf einem niedrigem Niveau bewegt, sollten solche Fälle aus dem Datensatz
entfernt werden:
...
dies führt dazu, dass keine Daten, durch fälschliches kopieren, unterschlagen werden.
