...
library(leaflet)
nrw <- geojson_read("/home/xanbono/blogs/rscriptpost/landkreise_simplify200.geojson",
                    what = "sp")
...
karte.nrw <-  setView(karte.nrw, 7.61,51.5,   zoom=2) 
...
labels <- sprintf("<strong>%s</strong><br/>%g Lehrkraft pro SuS",
                  nrw$GEN,
