...
Geographische-Informationssystemen (GIS) werden verwendet, um räumliche Informationen zu verarbeiten und abzubilden.
Ein Großteil der offenen Datensätze enthalten Ortsangaben,
die sich mit GIS anreichern lassen und R stellt zahlreiche [Pakete](https://cran.r-project.org/web/views/Spatial.html) zu
